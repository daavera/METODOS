...
void Leap_inicial(double* m, double* x,double* y,double* z,double* vx,double* vy,double* vz, double dt);
...
int main()
{
	...
	Leap_inicial(m,x,y,z,vx,vy,vz,dt);
	//printf("%e\t%e\n", x[ind(0,1)],x[ind(1,1)]);
	...
	{
		printf("%d,%e,%e,%e,%e,%e,%e\n", t,x[ind(t,0)], y[ind(t,0)],z[ind(t,0)],x[ind(t,1)], y[ind(t,1)],z[ind(t,1)]);
	}
